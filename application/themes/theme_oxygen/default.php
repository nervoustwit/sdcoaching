...
<head>
    ...
    <link id="css-preset" href="themes/oxygen/css/presets/preset1.css'); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php print $this->getStyleSheet('responsive.css'); ?>" />

  <!--[if lt IE 9]>
    <script src="themes/oxygen/js/html5shiv.js"></script>
    <script src="themes/oxygen/js/respond.min.js"></script>
  <![endif]-->
...
<body>
  ...
  <footer id="footer">
    ...
    <script type="text/javascript" src="themes/oxygen/js/jquery.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script type="text/javascript" src="themes/oxygen/js/jquery.inview.min.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/wow.min.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/mousescroll.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/smoothscroll.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/jquery.countTo.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/lightbox.min.js"></script>
    <script type="text/javascript" src="themes/oxygen/js/main.js"></script>
